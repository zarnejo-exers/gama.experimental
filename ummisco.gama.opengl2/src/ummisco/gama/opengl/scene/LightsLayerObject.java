			...
			if (light.drawLight && light.id != 0) {
				...
				if (light.type == LightPropertiesStructure.TYPE.POINT) {
					...
					final GeometryObject pointLight =
							new GeometryObject(sphereShape, light.color, ShapeType.SPHERE, false);
					...
					final GeometryObject spotLight = new GeometryObject(coneShape, light.color, ShapeType.CONE, false);
