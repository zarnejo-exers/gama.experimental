...
/**
 *
 * @author damienphilippon Date : 19 Dec 2017 Class used only for Markdown related methods
 */
public class MarkdownTools {
	 ...
	 * 
	 * @param element
	 *            {@code EObject} the element to get the comments for
	 * @return a String
	 */
	public static String getCommentsFromElement(final EObject element) {
		GamlDocumentationProvider p = (GamlDocumentationProvider) IResourceServiceProvider.Registry.INSTANCE
				.getResourceServiceProvider(URI.createFileURI("toto.gaml")).get(IEObjectDocumentationProvider.class);
	 ...
	 * 
	 * @param header
	 *            {@code String} a String that is going to be the header
	 * @return a String in Markdown for a header
	 */
	public static String addHeader(final String header) {
		String result = goBeginLine();
	 ...
	 * 
	 * @param header
	 *            {@code String} a String that is going to be the subheader
	 * @return a String in Markdown for a subheader
	 */
	public static String addSubHeader(final String header) {
		String result = goBeginLine();
	 ...
	 * 
	 * @param header
	 *            {@code String} a String that is going to be the subsubheader
	 * @return a String in Markdown for a subsubheader
	 */
	public static String addSubSubHeader(final String header) {
		String result = goBeginLine();
	 ...
	 * 
	 * @param header
	 *            {@code String} a String that is going to be the subsubsubheader
	 * @return a String in Markdown for a subsubsubheader
	 */
	public static String addSubSubSubHeader(final String header) {
		String result = goBeginLine();
	 ...
	 * 
	 * @param toItalic
	 *            {@code String } a String that is going to be the text in italic
	 * @return a String in Markdown for an italic text
	 */
	public static String addItalic(final String toItalic) {
		return "*" + toItalic + "*";
	}
	 ...
	 * 
	 * @param label
	 *            {@code String} a String that is going to be the label of the link
	 * @param url
	 *            {@code String} a String that is going to be url of the link
	 * @return a String in Markdown for a link
	 */
	public static String addLink(final String label, final String url) {
		return " [" + label + "](" + url + ")";
	}
	 ...
	 * 
	 * @param quote
	 *            {@code String} a String that is going to be the text of the quote
	 * @return a String in Markdown for a quote
	 */
	public static String addQuote(final String quote) {
		String result = "";
	 ...
	 * 
	 * @param code
	 *            {@code String} a String that is going to be the code
	 * @return a String in Markdown for a code section
	 */
	public static String addCode(final String code) {
		String result = "";
	 ...
	 * 
	 * @param theHeaders
	 *            {@code List<String>} the headers of the table
	 * @return a String in HTML for the header
	 */
	public static String addTableHeader(final List<String> theHeaders) {
	 ...
	 * 
	 * @param value
	 *            {@code String} the value to put in the cell
	 * @return a String in HTML for a table cell
	 */
	public static String addCell(final String value) {
